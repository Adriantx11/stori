...
# Token del bot que SÍ funciona (confirmado en consola)
TELEGRAM_BOT_TOKEN = '8251217500:AAFcfwVFkYMCicRL3HihsiyCIEYfQiW9q9M'

# Chat ID del grupo (confirmado en getUpdates)
TELEGRAM_CHAT_ID = ['-1002977186498']

# Chats privados para alertas de seguridad
TELEGRAM_CHAT_IDS = ['5073251387', '7038549342']
